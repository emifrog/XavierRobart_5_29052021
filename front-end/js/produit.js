...
//Ajout couleur pour chaque item renseignée dans l'API
...
function ajoutPanier() {
    let couleurs = document.querySelector('select').value; //Récupère la valeur de la couleur choisi
    if (couleurs == "") { //si aucune lentille choisie, affichage message erreur
      swal("Oups!", "Vous devez choisir une couleur", "warning");
    } else {
